const { transactions, books } = require('../../infrastructure/repositories/MockRepositories');
...
const renewBook = (transactionId) => {
  ...
  if (transaction.status !== 'issued') throw new Error('Book already returned or overdue');
